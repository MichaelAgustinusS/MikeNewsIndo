...
router.delete('/delete/(:id)',authentication_mdl.is_login, function(req, res, next) {
 ...
 req.flash('msg_info', 'Delete Berita Success'); 
 res.redirect('/customers');
 }
 });
 });
...
router.put('/edit/(:id)',authentication_mdl.is_login, function(req,res,next){
 req.assert('name', 'Please fill judul berita').notEmpty();
 ...
 req.flash('msg_info', 'Update Berita success'); 
...
router.post('/add',authentication_mdl.is_login, function(req, res, next) {
 ...
 req.flash('msg_info', 'Create Berita success'); 
 res.redirect('/customers');
 } 
 });
 });
